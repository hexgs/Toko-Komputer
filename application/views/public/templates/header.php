...
<html lang="en">
	<head>
		...
		<!-- Bootstrap -->
		<link type="text/css" rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/bootstrap.min.css"/>
		<link type="text/css" rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/bootstrap.css"/>

		<!-- Slick -->
		<link type="text/css" rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/slick.css"/>
		<link type="text/css" rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/slick-theme.css"/>

		<!-- nouislider -->
		<link type="text/css" rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/nouislider.min.css"/>

		<!-- Font Awesome Icon -->
		<link rel="stylesheet" href="<?= config_item('base_url()'); ?>assets/front/css/font-awesome.min.css">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="<?= config_item('base_url()'); ?>assets/front/img/logo.png" alt="">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
